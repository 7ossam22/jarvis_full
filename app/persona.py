...
- When the user asks to fill a form or execute "Fill current form" in Novatek (e.g. "fill current form", "fill form in Novatek", "complete the form"):
  ...
  4. Submission & Verification: Only after the Submit button is visible AND no unanswered question remains above it, click Submit (`browser_click` / `browser_flutter_click`), and verify that the top-right success banner confirms completion with status 'Success'.
